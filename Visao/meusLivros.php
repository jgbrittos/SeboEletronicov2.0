                    ...
                    if ($listaLivros) {
                        foreach ($listaLivros as $chave => $valor) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="modal" data-target="#modalExcluiLivro" href="#" title="Excluir Livro"> <img src="img/icone_lixeira.png" align="right" ></a>
                                </td>
                            </tr>
                    <?php
                }
...
<!-- Modal Excluir livro -->
<div class="modal fade" id="modalExcluiLivro" tabindex="-1" role="dialog" aria-labelledby="modalExcluiLivroLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
